...
let rubberbandCreator = function (freezeState, minDistance,globalSpeed){
...
const rubberband = rubberbandCreator(360, 100, globalSpeed);//new Rubberband(360, 100, globalSpeed);
